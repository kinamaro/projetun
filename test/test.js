...
while (!isValidChoice) {
    ...
    let choice = prompt("rester ? s'approcher ? : ");
    ...
    if (choice === "s'approcher") {
        ...
        console.log(personnage + " ne bouge pas les yeux rivés sur la fougère prêt/e à partir au moindre problème");
        isValidChoice = true;  
    } else {
        console.log("Choix invalide, veuillez choisir entre 's'approcher' ou 'rester'");
                                                ...
                                                setTimeout(() => {
                                                    ...
                                                    setTimeout(() => {
                                                        ...
                                                        setTimeout(() => {
                                                            ...
                                                            while (!isValidChoice) {
                                                                console.log("Où décides-tu de dormir ? (au pied / sur une branche)");
                                                                ...
                                                                if (choice === "au pied") {
                                                                    ...
                                                                    console.log("Choix invalide, veuillez choisir entre 'au pied' ou 'sur une branche'");
                                                                ...
                                                                setTimeout(() => {
                                                                    ...
                                                                    setTimeout(() => {
                                                                        ...
                                                                        while (!isValidChoice) {
                                                                            ...
                                                                            let choice = prompt("Que choisissez-vous ? 'une corde' ou 'autre endroit' : ");
                                                                            ...
                                                                            if (choice === "une corde") {
                                                                                ...
                                                                                console.log(personnage + " étant peu sérieux/se, se met à descendre seulement la fatigue lui fait faire une chute mortelle");
                                                                                console.log("FIN");
                                                                                isValidChoice = true;
                                                                            } else {
                                                                                console.log("Choix invalide, veuillez choisir entre 'une corde' ou 'autre endroit'");
